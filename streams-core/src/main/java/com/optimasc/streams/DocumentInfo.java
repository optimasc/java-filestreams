...
public class DocumentInfo
{
  ...
  /** Returns the format of the stream. The format 
   *  of the stream can be one of the following values: 
   *  <ul>
   *   <li>{@link #TYPE_BIG_ENDIAN}</li>
   *   <li>{@link #TYPE_LITTLE_ENDIAN}</li>
   *   <li>{@link #TYPE_CHARACTER}</li>
   *   <li>{@link #TYPE_UNKNOWN_ENDIAN}</li>
   *  </ul>
   *  
  ...
  /** Returns the size of the Document or chunk.
   * 
   *  @return The number of bytes for this chunk or document.
   *  */
  public long getSize()
  {
    return size;
